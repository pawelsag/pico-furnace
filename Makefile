...
CONFVAL_SPIN_COATER_DSHOT_WITH_TELEMETRY = 3
...
CONFIG_SPIN_COATER_RPM_FEEDBACK_PIN := 3
...
ifeq ($(CONFIG_SPIN_COATER),dshot)
	...
	CONFIG_SPIN_COATER_INTERNAL=$(CONFVAL_SPIN_COATER_DSHOT_WITH_TELEMETRY)
...
CFLAGS += -DCONFIG_SPIN_COATER_DSHOT_WITH_TELEMETRY=${CONFVAL_SPIN_COATER_DSHOT_WITH_TELEMETRY}
...
CFLAGS += -DCONFIG_SPIN_COATER_RPM_FEEDBACK_PIN=${CONFIG_SPIN_COATER_RPM_FEEDBACK_PIN}
