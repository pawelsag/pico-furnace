...
CONFVAL_SPIN_COATER_NONE = 0
CONFVAL_SPIN_COATER_PWM = 1
CONFVAL_SPIN_COATER_DSHOT = 2
CONFVAL_SPIN_COATER_BIDIR_DSHOT = 3
CONFVAL_SPIN_COATER_INVALID = 4 # Has to be last
...
CONFIG_SPIN_COATER := none
CONFIG_SPIN_COATER_ENGINE_CONTROL_PIN := 2
CONFIG_SPIN_COATER_ENGINE_CONTROL_PIN_REVERSED := 3
CONFIG_SPIN_COATER_RPM_SENSOR_PIN := 16
CONFIG_SPIN_COATER_RPM_UPDATE_DEFAULT_DELAY := 300
...
ifeq ($(CONFIG_SPIN_COATER),dshot)
	CONFIG_SPIN_COATER_INTERNAL=$(CONFVAL_SPIN_COATER_DSHOT)
else ifeq ($(CONFIG_SPIN_COATER),bidshot)
	CONFIG_SPIN_COATER_INTERNAL=$(CONFVAL_SPIN_COATER_BIDIR_DSHOT)
else ifeq ($(CONFIG_SPIN_COATER),pwm)
	CONFIG_SPIN_COATER_INTERNAL=$(CONFVAL_SPIN_COATER_PWM)
else ifeq ($(CONFIG_SPIN_COATER),none)
	CONFIG_SPIN_COATER_INTERNAL=$(CONFVAL_SPIN_COATER_NONE)
else
	CONFIG_SPIN_COATER_INTERNAL=$(CONFVAL_SPIN_COATER_INVALID)
endif
...
CFLAGS += -DCONFIG_SPIN_COATER=${CONFIG_SPIN_COATER_INTERNAL}
CFLAGS += -DCONFIG_SPIN_COATER_NONE=${CONFVAL_SPIN_COATER_NONE}
CFLAGS += -DCONFIG_SPIN_COATER_DSHOT=${CONFVAL_SPIN_COATER_DSHOT}
CFLAGS += -DCONFIG_SPIN_COATER_BIDIR_DSHOT=${CONFVAL_SPIN_COATER_BIDIR_DSHOT}
CFLAGS += -DCONFIG_SPIN_COATER_PWM=${CONFVAL_SPIN_COATER_PWM}
CFLAGS += -DCONFIG_SPIN_COATER_ENGINE_CONTROL_PIN=${CONFIG_SPIN_COATER_ENGINE_CONTROL_PIN}
CFLAGS += -DCONFIG_SPIN_COATER_ENGINE_CONTROL_PIN_REVERSED=${CONFIG_SPIN_COATER_ENGINE_CONTROL_PIN_REVERSED}
CFLAGS += -DCONFIG_SPIN_COATER_RPM_SENSOR_PIN=${CONFIG_SPIN_COATER_RPM_SENSOR_PIN}
CFLAGS += -DCONFIG_SPIN_COATER_RPM_UPDATE_DEFAULT_DELAY=${CONFIG_SPIN_COATER_RPM_UPDATE_DEFAULT_DELAY}
